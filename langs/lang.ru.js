 ...
 */
    ...
    const lang = {
        ...
        logs_voice_switch(member, oldChannel, newChannel) {
         ...
         //antiscam
         antiscam_use: "antiscam [enable/disable | action] {Действие}",
         antiscam_description: "Автоматически удалять и принимать меры при отправке подозрительных ссылок\n" +
             ":small_blue_diamond: `antiscam enable/disable`\n" +
             "Подключить или отключить Антискам\n" +
             ":small_blue_diamond: `antiscam action [Ban | Kick | Warn | Mute | none]`\n" +
             "Выбрать действие, которое нужно будет выполнить при обнаружении подозрительных ссылок",
         antiscam_small_desc: "Автоматически удалять и принимать меры при отправке подозрительных ссылок",
         antiscam_examples: "`antiscam enable`\n`antiscam ban`",
         //antiscam enable
         antiscam_enabled: "Антискам включен",
         antiscam_disabled: "Антискам отключен",
         //antiscam action
         antiscam_action_updated: (action) => {
             return `Действие Антискам обновлено, **Действие**: \`${action}\``
         },
         antiscam_acted: "[NISD AutoMod] Обнаружена подозрительная ссылка!",
    }
